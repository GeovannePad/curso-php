<?php
    ...
    // Colocando o tipo do arquivo que o PHP vai gerar, porém, ao declarar o Content Type como uma imagem, não dará para ver os erros do código, pois é uma imagem.
    ...
    // Função para definir o tipo da imagem como PNG.
    imagepng($image);
