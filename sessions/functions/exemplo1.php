<?php
    ...
    // Retorna um int(0) caso estiver desabilitada, um int(1) para caso estiver habilitada mas nenhuma sessão existir e retorna int(2) para caso estiver habilitada e exister pelo menos uma sessão.
